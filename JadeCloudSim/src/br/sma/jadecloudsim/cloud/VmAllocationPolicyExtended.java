...
public class VmAllocationPolicyExtended extends VmAllocationPolicy {
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		long currentAllocationTime = System.currentTimeMillis() - start;
		
		System.out.println("Allocation time = " + currentAllocationTime);
		
		allocationTime = allocationTime + (new Date().getTime() - start);
